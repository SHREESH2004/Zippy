...
import {
  MapPin, ShoppingCart, Pencil, Trash2, BadgeIndianRupee, PlusCircle, Clock
} from 'lucide-react';

const AccountUI = ({ loading, addresses, cart, onEditAddress, onDeleteAddress }) => {
    ...
    <div style={{ backgroundColor: 'white', fontFamily: 'sans-serif' }}>
      ...
      <div
        style={{
          height: '70vh',
          width: '100%',
          backgroundImage: `url('https://images.stockcake.com/public/7/2/2/722df067-a4fe-4eee-a94d-bf306602ddd1_large/urban-graffiti-alley-stockcake.jpg')`,
      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '4rem 1.5rem', display: 'flex', flexDirection: 'column', gap: '6rem' }}>
        ...
        <section>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2.5rem' }}>
            ...
            <button
              onClick={() => alert('Open Add Address Modal')}
              style={{
                display: 'flex',
                alignItems: 'center',
                gap: '0.5rem',
